...
app.get('/api', (req, res) => {
  ...
  res.json({
    ...
    endpoints: [
      ...
      {method: 'DELETE',path: '/api/books/:id',description: 'delete a book based on specified ID'}
    ]
  })
});
...
app.get('/api/profile', (req, res) => {
  res.json({
    ...
    'email': 'rudyard.kipling@junglebook.com',
    'deployedURLLink': '',//leave this blank for the first exercise
    'apiDocumentationURL': '', //leave this also blank for the first exercise
    'currentCity': 'Munich',
    'hobbies': ['Reading books','cricket','football','tennis','music']
