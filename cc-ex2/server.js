...
app.get('/api', (req, res) => {
  res.json({
    ...
    endpoints: [
      ...
      { method: 'GET', path: '/api/exercise2/', description: 'group 125 application deployed using docker' },
    ]
  })
});
...
app.get('/api/exercise2/', (req, res) => {
  console.log("group 125 application deployed using docker");
  res.json("group 125 application deployed using docker");
});
